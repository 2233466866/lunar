...
/******************************↓******************************/
    ...
    sprintf(
        ...
        is_leap == 1 ? "闰" : "",
        lunar_month_names[lunar_month],

        lunar_day_names[lunar_day],

        lunar_tiangan_names[year_cyl%10],
        lunar_dizhi_names[year_cyl%12],

        lunar_tiangan_names[mon_cyl%10],
        lunar_dizhi_names[mon_cyl%12],
