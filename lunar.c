...
/******************************↓******************************/
    ...
    sprintf(lunar_output, "%s-%s-%s-%s-%s", lunar_tiangan_names[year_cyl%10], lunar_dizhi_names[year_cyl%12], is_leap == 1 ? "闰" : "平", lunar_month_names[lunar_month], lunar_day_names[lunar_day]);
